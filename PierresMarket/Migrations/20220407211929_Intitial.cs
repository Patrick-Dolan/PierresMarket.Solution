        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatId = table.Column<int>(type: "int", nullable: false),
                    FlavorId = table.Column<int>(type: "int", nullable: false),
                    FlavorTreatId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlavorTreats_FlavorTreats_FlavorTreatId1",
                        column: x => x.FlavorTreatId1,
                        principalTable: "FlavorTreats",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlavorTreats_FlavorTreatId1",
                table: "FlavorTreats",
                column: "FlavorTreatId1");
